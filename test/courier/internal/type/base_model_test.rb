...
class Courier::Test::PrimitiveModelTest < Minitest::Test
  A = Courier::Internal::Type::ArrayOf[-> { Integer }]
  H = Courier::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Courier::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Courier::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Courier::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Courier::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Courier::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Courier::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Courier::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Courier::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Courier::Internal::Type::Boolean, true] => true,
      [Courier::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Courier::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Courier::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Courier::Internal::Type::Converter.new_coerce_state
      Courier::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Courier::Internal::Type::Converter.dump(target, input, state: state)
...
class Courier::Test::EnumModelTest < Minitest::Test
  class E0
    include Courier::Internal::Type::Enum
...
class Courier::Test::CollectionModelTest < Minitest::Test
  A1 = Courier::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Courier::Internal::Type::HashOf[Integer]

  A2 = Courier::Internal::Type::ArrayOf[H1]
  H2 = Courier::Internal::Type::HashOf[-> { A1 }]

  A3 = Courier::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Courier::Internal::Type::HashOf[Integer, nil?: true]
...
class Courier::Test::BaseModelTest < Minitest::Test
  class M1 < Courier::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Courier::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Courier::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Courier::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Courier::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Courier::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Courier::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Courier::Errors::ConversionError => e
...
class Courier::Test::UnionTest < Minitest::Test
  class U0
    include Courier::Internal::Type::Union
  ...
  class M2 < Courier::Internal::Type::BaseModel
  ...
  class M4 < Courier::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Courier::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Courier::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Courier::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Courier::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Courier::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Courier::Internal::Type::Unknown, Courier::Internal::Type::Unknown] => true,
      [Courier::Internal::Type::Boolean, Courier::Internal::Type::Boolean] => true,
      [Courier::Internal::Type::Unknown, Courier::Internal::Type::Boolean] => false,
...
class Courier::Test::MetaInfoTest < Minitest::Test
  A1 = Courier::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Courier::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
