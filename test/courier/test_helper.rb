...
class Courier::Test::SingletonClient < Courier::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Courier::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Courier::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @courier = Courier::Test::SingletonClient.instance
  end
