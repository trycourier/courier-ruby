...
class Trycourier::Test::PrimitiveModelTest < Minitest::Test
  A = Trycourier::Internal::Type::ArrayOf[-> { Integer }]
  H = Trycourier::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Trycourier::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Trycourier::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Trycourier::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Trycourier::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Trycourier::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Trycourier::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Trycourier::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Trycourier::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Trycourier::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Trycourier::Internal::Type::Boolean, true] => true,
      [Trycourier::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Trycourier::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Trycourier::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Trycourier::Internal::Type::Converter.new_coerce_state
      Trycourier::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Trycourier::Internal::Type::Converter.dump(target, input, state: state)
...
class Trycourier::Test::EnumModelTest < Minitest::Test
  class E0
    include Trycourier::Internal::Type::Enum
...
class Trycourier::Test::CollectionModelTest < Minitest::Test
  A1 = Trycourier::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Trycourier::Internal::Type::HashOf[Integer]

  A2 = Trycourier::Internal::Type::ArrayOf[H1]
  H2 = Trycourier::Internal::Type::HashOf[-> { A1 }]

  A3 = Trycourier::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Trycourier::Internal::Type::HashOf[Integer, nil?: true]
...
class Trycourier::Test::BaseModelTest < Minitest::Test
  class M1 < Trycourier::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Trycourier::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Trycourier::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Trycourier::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Trycourier::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Trycourier::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Trycourier::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Trycourier::Errors::ConversionError => e
...
class Trycourier::Test::UnionTest < Minitest::Test
  class U0
    include Trycourier::Internal::Type::Union
  ...
  class M2 < Trycourier::Internal::Type::BaseModel
  ...
  class M4 < Trycourier::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Trycourier::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Trycourier::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Trycourier::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Trycourier::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Trycourier::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Trycourier::Internal::Type::Unknown, Trycourier::Internal::Type::Unknown] => true,
      [Trycourier::Internal::Type::Boolean, Trycourier::Internal::Type::Boolean] => true,
      [Trycourier::Internal::Type::Unknown, Trycourier::Internal::Type::Boolean] => false,
...
class Trycourier::Test::MetaInfoTest < Minitest::Test
  A1 = Trycourier::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Trycourier::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
