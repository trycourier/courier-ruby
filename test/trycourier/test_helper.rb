...
class Trycourier::Test::SingletonClient < Trycourier::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Trycourier::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Trycourier::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @courier = Trycourier::Test::SingletonClient.instance
  end
