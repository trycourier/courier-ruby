    ...
    module Users
      class TenantListResponse < Trycourier::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Trycourier::Models::Users::TenantListResponse,
        ...
        sig do
          returns(
            Trycourier::Models::Users::TenantListResponse::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          params(
            has_more: T::Boolean,
            type: Trycourier::Models::Users::TenantListResponse::Type::OrSymbol,
            url: String,
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Trycourier::Models::Users::TenantListResponse::Type)
            end
