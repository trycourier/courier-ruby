    ...
    module Type
      class BaseModel
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Trycourier::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Trycourier::Internal::Type::BaseModel::KnownField,
                  { type: Trycourier::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Trycourier::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(Trycourier::Internal::AnyHash) }
        def to_h
        end
