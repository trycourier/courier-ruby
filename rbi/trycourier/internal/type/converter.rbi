  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Trycourier::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            ...
            ).returns(Trycourier::Internal::AnyHash)
          end
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Trycourier::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Trycourier::Internal::Type::Converter::Input,
              value: T.anything,
              state: Trycourier::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
