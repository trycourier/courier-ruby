  ...
  module Models
    ...
    module Users
      class UserToken < Courier::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Courier::Users::UserToken, Courier::Internal::AnyHash)
          end

        sig { returns(Courier::Users::UserToken::ProviderKey::TaggedSymbol) }
        ...
        sig { returns(T.nilable(Courier::Users::UserToken::Device)) }
        attr_reader :device
        ...
        # Information about the device the token is associated with.
        sig { returns(T.nilable(Courier::Users::UserToken::Tracking)) }
        ...
        sig do
          override.returns(
            {
              provider_key:
                Courier::Users::UserToken::ProviderKey::TaggedSymbol,
              token: T.nilable(String),
              device: T.nilable(Courier::Users::UserToken::Device),
              expiry_date:
                T.nilable(Courier::Users::UserToken::ExpiryDate::Variants),
              properties: T.anything,
              tracking: T.nilable(Courier::Users::UserToken::Tracking)
            }
          )
        end
        def to_hash
        ...
        module ProviderKey
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Courier::Users::UserToken::ProviderKey)
            end
          ...
          APN =
            T.let(:apn, Courier::Users::UserToken::ProviderKey::TaggedSymbol)
          EXPO =
            T.let(:expo, Courier::Users::UserToken::ProviderKey::TaggedSymbol)
          ONESIGNAL =
            T.let(
              :onesignal,
              Courier::Users::UserToken::ProviderKey::TaggedSymbol
          ...
          sig do
            override.returns(
              T::Array[Courier::Users::UserToken::ProviderKey::TaggedSymbol]
            )
          end
          def self.values
          end
        ...
        class Device < Courier::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Courier::Users::UserToken::Device,
        ...
        module ExpiryDate
          ...
          sig do
            override.returns(
              T::Array[Courier::Users::UserToken::ExpiryDate::Variants]
            )
          end
          def self.variants
          end
        ...
        class Tracking < Courier::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Courier::Users::UserToken::Tracking,
                Courier::Internal::AnyHash
              )
            end
