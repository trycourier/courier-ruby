  ...
  module Models
    class MessageGetContentResponse < Courier::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Courier::Models::MessageGetContentResponse,
      ...
      sig do
        returns(T::Array[Courier::Models::MessageGetContentResponse::Result])
      end
      ...
      sig do
        params(
          results:
            T::Array[Courier::Models::MessageGetContentResponse::Result::OrHash]
      ...
      sig do
        override.returns(
          {
            results:
              T::Array[Courier::Models::MessageGetContentResponse::Result]
          }
        )
      end
      def to_hash
      ...
      class Result < Courier::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Courier::Models::MessageGetContentResponse::Result,
              Courier::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(Courier::Models::MessageGetContentResponse::Result::Content)
        end
        attr_reader :content
        ...
        sig do
          params(
            content:
              Courier::Models::MessageGetContentResponse::Result::Content::OrHash
          ).void
        end
        attr_writer :content
          ...
          override.returns(
            {
              ...
              channel_id: String,
              content:
                Courier::Models::MessageGetContentResponse::Result::Content
            }
          )
        end
        def to_hash
        ...
        class Content < Courier::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                Courier::Models::MessageGetContentResponse::Result::Content::Block
              ]
            )
          end
          ...
          sig do
            params(
              blocks:
                T::Array[
                  Courier::Models::MessageGetContentResponse::Result::Content::Block::OrHash
                ],
              body: String,
              html: String,
              subject: String,
