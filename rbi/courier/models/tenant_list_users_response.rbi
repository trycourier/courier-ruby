  ...
  module Models
    class TenantListUsersResponse < Courier::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Courier::Models::TenantListUsersResponse,
      ...
      sig do
        returns(Courier::Models::TenantListUsersResponse::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        params(
          has_more: T::Boolean,
          type: Courier::Models::TenantListUsersResponse::Type::OrSymbol,
          url: String,
          cursor: T.nilable(String),
          items: T.nilable(T::Array[Courier::Users::TenantAssociation::OrHash]),
      ...
      sig do
        override.returns(
          {
            has_more: T::Boolean,
            type: Courier::Models::TenantListUsersResponse::Type::TaggedSymbol,
            url: String,
            cursor: T.nilable(String),
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Courier::Models::TenantListUsersResponse::Type)
          end
        ...
        LIST =
          T.let(
            :list,
            Courier::Models::TenantListUsersResponse::Type::TaggedSymbol
          )
