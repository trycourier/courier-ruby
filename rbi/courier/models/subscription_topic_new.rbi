...
module Courier
  module Models
    class SubscriptionTopicNew < Courier::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Courier::SubscriptionTopicNew, Courier::Internal::AnyHash)
        end

      sig { returns(Courier::SubscriptionTopicNew::Status::OrSymbol) }
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Courier::SubscriptionTopicNew::Status) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        OPTED_OUT =
          T.let(:OPTED_OUT, Courier::SubscriptionTopicNew::Status::TaggedSymbol)
        OPTED_IN =
          T.let(:OPTED_IN, Courier::SubscriptionTopicNew::Status::TaggedSymbol)
        REQUIRED =
          T.let(:REQUIRED, Courier::SubscriptionTopicNew::Status::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Courier::SubscriptionTopicNew::Status::TaggedSymbol]
          )
        end
        def self.values
        end
