    ...
    module Tenants
      class ElementalChannelNode < Courier::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Courier::Tenants::ElementalChannelNode,
        ...
        sig { returns(T.nilable(T::Array[Courier::Tenants::ElementalNode])) }
        ...
        sig do
          params(
            ...
            elements: T.nilable(T::Array[Courier::Tenants::ElementalNode]),
