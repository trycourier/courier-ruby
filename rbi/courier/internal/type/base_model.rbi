    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Courier::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Courier::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Courier::Internal::Type::BaseModel::KnownField,
                  { type: Courier::Internal::Type::Converter::Input }
                )
              ]
            )
          end
                ...
                T.any(
                  {
                    ...
                    enum:
                      T.nilable(
                        T.proc.returns(
                          Courier::Internal::Type::Converter::Input
                        )
                      ),
                    union:
                      T.nilable(
        ...
        class << self
          ...
          sig do
            params(
              model: Courier::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(Courier::Internal::AnyHash) }
        def to_h
        end
