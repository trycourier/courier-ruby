...
module Courier
  class Notifications
    class SubmissionChecksReplaceResponse
      ...
      # Deserialize a JSON object to an instance of SubmissionChecksReplaceResponse
      #
      ...
      # Serialize an instance of SubmissionChecksReplaceResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
