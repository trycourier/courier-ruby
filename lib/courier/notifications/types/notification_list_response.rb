...
module Courier
  class Notifications
    class NotificationListResponse
      ...
      # @param results [Array<Notifications::Notification>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Notifications::NotificationListResponse]
      def initialize(paging:, results:, additional_properties: nil)
        # @type [Commons::Paging]
        @paging = paging
        # @type [Array<Notifications::Notification>]
        @results = results
        # @type [OpenStruct] Additional properties unmapped to the current class definition
        @additional_properties = additional_properties
      end

      # Deserialize a JSON object to an instance of NotificationListResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |v|
          v = v.to_json
          Notifications::Notification.from_json(json_object: v)
        end
        new(paging: paging, results: results, additional_properties: struct)
      end

      # Serialize an instance of NotificationListResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
