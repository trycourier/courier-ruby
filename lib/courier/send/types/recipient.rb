...
require_relative "pagerduty_recipient"
require_relative "webhook_recipient"
  ...
  class Send
    class Recipient
      ...
      def self.from_json(json_object:)
        ...
        begin
          Send::PagerdutyRecipient.validate_raw(obj: struct)
          return Send::PagerdutyRecipient.from_json(json_object: json_object)
        rescue StandardError
          # noop
        end
        begin
          Send::WebhookRecipient.validate_raw(obj: struct)
          return Send::WebhookRecipient.from_json(json_object: json_object)
        rescue StandardError
          # noop
        end
        struct
      ...
      def self.validate_raw(obj:)
        ...
        begin
          return Send::PagerdutyRecipient.validate_raw(obj: obj)
        rescue StandardError
          # noop
        end
        begin
          return Send::WebhookRecipient.validate_raw(obj: obj)
        rescue StandardError
          # noop
        end
