...
module Courier
  class Send
    ...
    class ContentMessage
      attr_reader :content, :data, :brand_id, :channels, :context, :metadata, :preferences, :providers, :routing,
                  :timeout, :delay, :expiry, :to, :additional_properties
      ...
      def initialize(content:, data: nil, brand_id: nil, channels: nil, context: nil, metadata: nil, preferences: nil,
                     providers: nil, routing: nil, timeout: nil, delay: nil, expiry: nil, to: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(content: content, data: data, brand_id: brand_id, channels: channels, context: context, metadata: metadata,
            preferences: preferences, providers: providers, routing: routing, timeout: timeout, delay: delay, expiry: expiry, to: to, additional_properties: struct)
      end
