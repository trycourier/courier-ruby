...
module Courier
  class MessagesClient
    ...
    # @param cursor [String] A unique identifier that allows for fetching the next set of messages.
    ...
    # @param provider [String] The key assocated to the provider you want to filter on. E.g., sendgrid, inbox, twilio, slack, msteams, etc. Allows multiple values to be set in query parameters.
    # @param recipient [String] A unique identifier representing the recipient associated with the requested profile.
    # @param status [String] An indicator of the current status of the message. Allows multiple values to be set in query parameters.
    # @param tag [String] A tag placed in the metadata.tags during a notification send. Allows multiple values to be set in query parameters.
    # @param tags [String] A comma delimited list of 'tags'. Messages will be returned if they match any of the tags passed in.
    # @param tenant_id [String] Messages sent with the context of a Tenant
    ...
    def list(archived: nil, cursor: nil, event: nil, list: nil, message_id: nil, notification: nil, provider: nil,
             recipient: nil, status: nil, tag: nil, tags: nil, tenant_id: nil, enqueued_after: nil, trace_id: nil, request_options: nil)
