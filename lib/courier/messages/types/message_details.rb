...
module Courier
  class Messages
    class MessageDetails
      ...
      # @param enqueued [Long] A UTC timestamp at which Courier received the message request. Stored as a millisecond representation of the Unix epoch.
      # @param sent [Long] A UTC timestamp at which Courier passed the message to the Integration provider. Stored as a millisecond representation of the Unix epoch.
      # @param delivered [Long] A UTC timestamp at which the Integration provider delivered the message. Stored as a millisecond representation of the Unix epoch.
      # @param opened [Long] A UTC timestamp at which the recipient opened a message for the first time. Stored as a millisecond representation of the Unix epoch.
      # @param clicked [Long] A UTC timestamp at which the recipient clicked on a tracked link for the first time. Stored as a millisecond representation of the Unix epoch.
      ...
      def initialize(id:, status:, enqueued:, sent:, delivered:, opened:, clicked:, recipient:, event:, notification:,
        ...
        @status = status
        # @type [Long] A UTC timestamp at which Courier received the message request. Stored as a millisecond representation of the Unix epoch.
        @enqueued = enqueued
        # @type [Long] A UTC timestamp at which Courier passed the message to the Integration provider. Stored as a millisecond representation of the Unix epoch.
        @sent = sent
        # @type [Long] A UTC timestamp at which the Integration provider delivered the message. Stored as a millisecond representation of the Unix epoch.
        @delivered = delivered
        # @type [Long] A UTC timestamp at which the recipient opened a message for the first time. Stored as a millisecond representation of the Unix epoch.
        @opened = opened
        # @type [Long] A UTC timestamp at which the recipient clicked on a tracked link for the first time. Stored as a millisecond representation of the Unix epoch.
        @clicked = clicked
      ...
      def self.validate_raw(obj:)
        ...
        obj.enqueued.is_a?(Long) != false || raise("Passed value for field obj.enqueued is not the expected type, validation failed.")
        obj.sent.is_a?(Long) != false || raise("Passed value for field obj.sent is not the expected type, validation failed.")
        obj.delivered.is_a?(Long) != false || raise("Passed value for field obj.delivered is not the expected type, validation failed.")
        obj.opened.is_a?(Long) != false || raise("Passed value for field obj.opened is not the expected type, validation failed.")
        obj.clicked.is_a?(Long) != false || raise("Passed value for field obj.clicked is not the expected type, validation failed.")
