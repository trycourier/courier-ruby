    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Courier::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Courier::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Courier::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Courier::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Courier::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Courier::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Courier::Internal::Type::Converter
              ...
              Courier::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Courier::Internal::Type::Converter, T::Class[T.anything]) }
        end
