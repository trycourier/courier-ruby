...
module Courier
  class Templates
    class ListTemplatesResponse
      ...
      # @param results [Array<Templates::NotificationTemplates>] An array of Notification Templates
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Templates::ListTemplatesResponse]
      def initialize(paging:, results:, additional_properties: nil)
        # @type [Commons::Paging]
        @paging = paging
        # @type [Array<Templates::NotificationTemplates>] An array of Notification Templates
        @results = results
        # @type [OpenStruct] Additional properties unmapped to the current class definition
        @additional_properties = additional_properties
      end

      # Deserialize a JSON object to an instance of ListTemplatesResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |v|
          v = v.to_json
          Templates::NotificationTemplates.from_json(json_object: v)
        end
        new(paging: paging, results: results, additional_properties: struct)
      end

      # Serialize an instance of ListTemplatesResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
