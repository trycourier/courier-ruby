...
require_relative "get_list_subscriptions_list"
require "json"

module Courier
  class Profiles
    class GetListSubscriptionsResponse
      attr_reader :paging, :results, :additional_properties

      # @param paging [Commons::Paging]
      # @param results [Array<Profiles::GetListSubscriptionsList>] An array of lists
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Profiles::GetListSubscriptionsResponse]
      def initialize(paging:, results:, additional_properties: nil)
        # @type [Commons::Paging]
        @paging = paging
        # @type [Array<Profiles::GetListSubscriptionsList>] An array of lists
        @results = results
        # @type [OpenStruct] Additional properties unmapped to the current class definition
        @additional_properties = additional_properties
      end

      # Deserialize a JSON object to an instance of GetListSubscriptionsResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |v|
          v = v.to_json
          Profiles::GetListSubscriptionsList.from_json(json_object: v)
        end
        new(paging: paging, results: results, additional_properties: struct)
      end

      # Serialize an instance of GetListSubscriptionsResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
