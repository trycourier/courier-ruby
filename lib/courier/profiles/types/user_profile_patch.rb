...
module Courier
  class Profiles
    class UserProfilePatch
      ...
      # @return [Profiles::UserProfilePatch]
      def initialize(op:, path:, value:, additional_properties: nil)
      ...
      # Deserialize a JSON object to an instance of UserProfilePatch
      #
      ...
      # Serialize an instance of UserProfilePatch to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
