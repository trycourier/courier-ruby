...
module Courier
  module Models
    class SubscriptionTopicNew < Courier::Internal::Type::BaseModel
      # @!attribute status
      #
      #   @return [Symbol, Courier::Models::SubscriptionTopicNew::Status]
      ...
      #   {Courier::Models::SubscriptionTopicNew} for more details.
      #
      #   @param status [Symbol, Courier::Models::SubscriptionTopicNew::Status]
      #
      #   @param custom_routing [Array<Symbol, Courier::Models::ChannelClassification>, nil] The default channels to send to this tenant when has_custom_routing is enabled
      #
      #   @param has_custom_routing [Boolean, nil] Override channel routing with custom preferences. This will override any templat

      # @see Courier::Models::SubscriptionTopicNew#status
      module Status
