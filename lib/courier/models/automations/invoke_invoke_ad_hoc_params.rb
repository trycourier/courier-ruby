      ...
      class InvokeInvokeAdHocParams < Courier::Internal::Type::BaseModel
        ...
        class Automation < Courier::Internal::Type::BaseModel
          ...
          module Step
            ...
            variant -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToDigestStep }

            variant -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep }

            variant -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep }
            ...
            variant -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationV2SendStep }
            ...
            class AutomationAddToDigestStep < Courier::Models::Automations::AutomationStep
              # @!attribute action
              #
              #   @return [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToDigestStep::Action]
              required :action,
                       enum: -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToDigestStep::Action }
              ...
              #   @param action [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToDigestStep::Action]
              #
            ...
            class AutomationAddToBatchStep < Courier::Models::Automations::AutomationStep
              # @!attribute action
              #
              #   @return [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Action]
              required :action,
                       enum: -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Action }
              ...
              #
              #   @return [Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Retain]
              required :retain,
              ...
              optional :max_items,
                       union: -> {
                         Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::MaxItems
                       },
                       nil?: true
              ...
              #
              #   @return [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Scope, nil]
              optional :scope,
                       enum: -> {
                         Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Scope
                       },
                       nil?: true
              ...
              #   {Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep}
              #   for more details.
              #
              #   @param action [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Action]
              #
              #   @param max_wait_period [String] Defines the maximum wait time before the batch should be released. Must be less
              #
              #   @param retain [Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Retain] Defines what items should be retained and passed along to the next steps when th
              #
              ...
              #
              #   @param scope [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Scope, nil] Determine the scope of the batching. If user, chosen in this order: recipient, p
              ...
              class Retain < Courier::Internal::Type::BaseModel
                ...
                #
                #   @return [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Retain::Type]
                required :type,
                         enum: -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Retain::Type }
                ...
                #   Some parameter documentations has been truncated, see
                #   {Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Retain}
                #   for more details.
                #
                #   Defines what items should be retained and passed along to the next steps when
                #   the batch is released
                ...
                #
                #   @param type [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Retain::Type] Keep N number of notifications based on the type. First/Last N based on notifica
                #
                ...
                # data accessed by sort_key
                #
                # @see Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationAddToBatchStep::Retain#type
                module Type
                  extend Courier::Internal::Type::Enum
            ...
            class AutomationThrottleStep < Courier::Models::Automations::AutomationStep
              # @!attribute action
              #
              #   @return [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep::Action]
              required :action,
                       enum: -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep::Action }
              ...
              #
              #   @return [Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep::OnThrottle]
              ...
              # @!attribute scope
              #
              #   @return [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep::Scope]
              required :scope,
                       enum: -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep::Scope }
              ...
              #   Some parameter documentations has been truncated, see
              #   {Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep}
              #   for more details.
              #
              #   @param action [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep::Action]
              #
              #   @param max_allowed [Integer] Maximum number of allowed notifications in that timeframe
              #
              #   @param on_throttle [Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep::OnThrottle]
              #
              #   @param period [String] Defines the throttle period which corresponds to the max_allowed. Specified as a
              #
              #   @param scope [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationThrottleStep::Scope]
              #
            ...
            class AutomationDelayStep < Courier::Models::Automations::AutomationStep
              ...
              #   Some parameter documentations has been truncated, see
              #   {Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationDelayStep}
              #   for more details.
              #
            ...
            class AutomationV2SendStep < Courier::Models::Automations::AutomationStep
              # @!attribute action
              #
              #   @return [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationV2SendStep::Action]
              required :action,
                       enum: -> { Courier::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationV2SendStep::Action }
              ...
              #   Some parameter documentations has been truncated, see
              #   {Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationV2SendStep}
              #   for more details.
              #
              #   @param action [Symbol, Courier::Models::Automations::InvokeInvokeAdHocParams::Automation::Step::AutomationV2SendStep::Action]
              #
