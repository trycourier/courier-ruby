  ...
  module Models
    ...
    module Content
      ...
      class ElementalContent < Courier::Internal::Type::BaseModel
        # @!attribute elements
        #
        #   @return [Array<Courier::Models::Content::ElementalContent::Element::UnionMember0, Courier::Models::Content::ElementalContent::Element::UnionMember1, Courier::Models::Content::ElementalContent::Element::Type, Courier::Models::Content::ElementalContent::Element::UnionMember3, Courier::Models::Content::ElementalContent::Element::UnionMember4, Courier::Models::Content::ElementalContent::Element::UnionMember5, Courier::Models::Content::ElementalContent::Element::UnionMember7>]
        required :elements,
        ...
        #   @param elements [Array<Courier::Models::Content::ElementalContent::Element::UnionMember0, Courier::Models::Content::ElementalContent::Element::UnionMember1, Courier::Models::Content::ElementalContent::Element::Type, Courier::Models::Content::ElementalContent::Element::UnionMember3, Courier::Models::Content::ElementalContent::Element::UnionMember4, Courier::Models::Content::ElementalContent::Element::UnionMember5, Courier::Models::Content::ElementalContent::Element::UnionMember7>]
        #
        ...
        module Element
          ...
          variant -> { Courier::Content::ElementalContent::Element::Type }
          ...
          variant -> { Courier::Content::ElementalContent::Element::UnionMember7 }
          ...
          class Type < Courier::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, Courier::Models::Content::ElementalContent::Element::Type::Type]
            required :type, enum: -> { Courier::Content::ElementalContent::Element::Type::Type }

            # @!method initialize(type:)
            #   @param type [Symbol, Courier::Models::Content::ElementalContent::Element::Type::Type]

            # @see Courier::Models::Content::ElementalContent::Element::Type#type
            module Type
              extend Courier::Internal::Type::Enum
          ...
          class UnionMember7 < Courier::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, Courier::Models::Content::ElementalContent::Element::UnionMember7::Type, nil]
            optional :type, enum: -> { Courier::Content::ElementalContent::Element::UnionMember7::Type }
            ...
            #   @param loop_ [String, nil]
            #   @param ref [String, nil]
            #   @param type [Symbol, Courier::Models::Content::ElementalContent::Element::UnionMember7::Type]

            # @see Courier::Models::Content::ElementalContent::Element::UnionMember7#type
            module Type
              extend Courier::Internal::Type::Enum
          ...
          #   @return [Array(Courier::Models::Content::ElementalContent::Element::UnionMember0, Courier::Models::Content::ElementalContent::Element::UnionMember1, Courier::Models::Content::ElementalContent::Element::Type, Courier::Models::Content::ElementalContent::Element::UnionMember3, Courier::Models::Content::ElementalContent::Element::UnionMember4, Courier::Models::Content::ElementalContent::Element::UnionMember5, Courier::Models::Content::ElementalContent::Element::Type, Courier::Models::Content::ElementalContent::Element::UnionMember7)]
        end
      end
