...
module Courier
  module Models
    # @see Courier::Resources::Messages#get_content
    class MessageGetContentResponse < Courier::Internal::Type::BaseModel
      # @!attribute results
      #   An array of render output of a previously sent message.
      #
      #   @return [Array<Courier::Models::MessageGetContentResponse::Result>]
      required :results,
               -> { Courier::Internal::Type::ArrayOf[Courier::Models::MessageGetContentResponse::Result] }

      # @!method initialize(results:)
      #   @param results [Array<Courier::Models::MessageGetContentResponse::Result>] An array of render output of a previously sent message.
      ...
      class Result < Courier::Internal::Type::BaseModel
        ...
        #
        #   @return [Courier::Models::MessageGetContentResponse::Result::Content]
        required :content, -> { Courier::Models::MessageGetContentResponse::Result::Content }
        ...
        #
        #   @param content [Courier::Models::MessageGetContentResponse::Result::Content] Content details of the rendered message.

        # @see Courier::Models::MessageGetContentResponse::Result#content
        class Content < Courier::Internal::Type::BaseModel
          # @!attribute blocks
          #   The blocks of the rendered message.
          #
          #   @return [Array<Courier::Models::MessageGetContentResponse::Result::Content::Block>]
          required :blocks,
                   -> { Courier::Internal::Type::ArrayOf[Courier::Models::MessageGetContentResponse::Result::Content::Block] }
          ...
          #   Content details of the rendered message.
          #
          #   @param blocks [Array<Courier::Models::MessageGetContentResponse::Result::Content::Block>] The blocks of the rendered message.
          #
