  ...
  module Models
    ...
    class BulkRetrieveJobResponse < Courier::Internal::Type::BaseModel
      ...
      class Job < Courier::Internal::Type::BaseModel
        ...
        required :definition, union: -> { Courier::InboundBulkMessage }
        ...
        #   @param definition [Courier::Models::InboundBulkMessage::InboundBulkTemplateMessage, Courier::Models::InboundBulkMessage::InboundBulkContentMessage]
