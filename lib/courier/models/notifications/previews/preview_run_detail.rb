    ...
    module Notifications
      module Previews
        ...
        class PreviewRunDetail < Courier::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Courier::Models::Notifications::Previews::PreviewResult>]
          required :results,
          ...
          # @!method initialize(id:, created_at:, device_ids:, results:, status:, template_id:, failure_reason: nil, template_version: nil)
          #   Some parameter documentations has been truncated, see
          #   {Courier::Models::Notifications::Previews::PreviewRunDetail} for more details.
          #
          ...
          #
          #   @param results [Array<Courier::Models::Notifications::Previews::PreviewResult>] One entry per device in `device_ids`.
          #
