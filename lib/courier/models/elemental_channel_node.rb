...
module Courier
  module Models
    class ElementalChannelNode < Courier::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Courier::Models::ElementalNode>, nil]
      optional :elements, -> { Courier::Internal::Type::ArrayOf[union: Courier::ElementalNode] }, nil?: true
      ...
      #
      #   @param elements [Array<Courier::Models::ElementalNode>, nil] An array of elements to apply to the channel. If `raw` has not been
      #
