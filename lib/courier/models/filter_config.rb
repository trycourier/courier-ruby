...
module Courier
  module Models
    class FilterConfig < Courier::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Courier::Models::FilterConfig>, nil]
      optional :filters, -> { Courier::Internal::Type::ArrayOf[Courier::FilterConfig] }
      ...
      #   {Courier::Models::FilterConfig} for more details.
      #
      ...
      #
      #   @param filters [Array<Courier::Models::FilterConfig>] Nested filter rules to combine with AND/OR. Required for nested filter groups, n
      #
