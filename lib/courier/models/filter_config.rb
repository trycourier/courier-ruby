...
module Courier
  module Models
    class FilterConfig < Courier::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Courier::Models::FilterConfig::Operator]
      required :operator, enum: -> { Courier::FilterConfig::Operator }
      ...
      #
      #   @param operator [Symbol, Courier::Models::FilterConfig::Operator] The operator to use for filtering
      #
      ...
      # The operator to use for filtering
      #
      # @see Courier::Models::FilterConfig#operator
      module Operator
