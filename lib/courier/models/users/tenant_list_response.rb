...
module Courier
  module Models
    module Users
      # @see Courier::Resources::Users::Tenants#list
      class TenantListResponse < Courier::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Courier::Models::Users::TenantListResponse::Type]
        required :type, enum: -> { Courier::Models::Users::TenantListResponse::Type }
        ...
        optional :items,
                 -> {
                   Courier::Internal::Type::ArrayOf[Courier::Users::TenantAssociation]
                 },
                 nil?: true
        ...
        #   {Courier::Models::Users::TenantListResponse} for more details.
        #
        #   @param has_more [Boolean] Set to true when there are more pages that can be retrieved.
        #
        #   @param type [Symbol, Courier::Models::Users::TenantListResponse::Type] Always set to `list`. Represents the type of this object.
        #
        ...
        # Always set to `list`. Represents the type of this object.
        #
        # @see Courier::Models::Users::TenantListResponse#type
        module Type
