  ...
  module Models
    module Users
      class UserToken < Courier::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Courier::Models::Users::UserToken::ProviderKey]
        required :provider_key, enum: -> { Courier::Users::UserToken::ProviderKey }
        ...
        #
        #   @return [Courier::Models::Users::UserToken::Device, nil]
        ...
        #   Information about the device the token is associated with.
        #
        #   @return [Courier::Models::Users::UserToken::Tracking, nil]
        optional :tracking, -> { Courier::Users::UserToken::Tracking }, nil?: true

        # @!method initialize(provider_key:, token: nil, device: nil, expiry_date: nil, properties: nil, tracking: nil)
        #   Some parameter documentations has been truncated, see
        #   {Courier::Models::Users::UserToken} for more details.
        #
        #   @param provider_key [Symbol, Courier::Models::Users::UserToken::ProviderKey]
        #
        #   @param token [String, nil] Full body of the token. Must match token in URL.
        #
        #   @param device [Courier::Models::Users::UserToken::Device, nil] Information about the device the token is associated with.
        #
        ...
        #
        #   @param tracking [Courier::Models::Users::UserToken::Tracking, nil] Information about the device the token is associated with.

        # @see Courier::Models::Users::UserToken#provider_key
        module ProviderKey
        ...
        # @see Courier::Models::Users::UserToken#device
        ...
        # @see Courier::Models::Users::UserToken#tracking
