  ...
  module Models
    module Users
      class TenantAssociation < Courier::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Courier::Models::Users::TenantAssociation::Type, nil]
        optional :type, enum: -> { Courier::Users::TenantAssociation::Type }, nil?: true
        ...
        #   {Courier::Models::Users::TenantAssociation} for more details.
        #
        ...
        #
        #   @param type [Symbol, Courier::Models::Users::TenantAssociation::Type, nil]
        #
        #   @param user_id [String, nil] User ID for the association between tenant and user

        # @see Courier::Models::Users::TenantAssociation#type
        module Type
