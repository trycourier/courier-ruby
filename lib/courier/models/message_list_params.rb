...
module Courier
  module Models
    ...
    class MessageListParams < Courier::Internal::Type::BaseModel
      ...
      #
      #   @return [Boolean, nil]
      optional :archived, Courier::Internal::Type::Boolean, nil?: true
      ...
      optional :provider, Courier::Internal::Type::ArrayOf[String, nil?: true]
      ...
      #
      #   @return [Array<String, nil>, nil]
      optional :status, Courier::Internal::Type::ArrayOf[String, nil?: true]
      ...
      #
      #   @return [Array<String, nil>, nil]
      optional :tag, Courier::Internal::Type::ArrayOf[String, nil?: true]
