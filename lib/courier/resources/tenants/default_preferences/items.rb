    ...
    class Tenants
      class DefaultPreferences
        class Items
          ...
          # {Courier::Models::Tenants::DefaultPreferences::ItemUpdateParams} for more
          # details.
          #
          ...
          # @return [nil]
          #
          # @see Courier::Models::Tenants::DefaultPreferences::ItemUpdateParams
          def update(topic_id, params)
            parsed, options = Courier::Tenants::DefaultPreferences::ItemUpdateParams.dump_request(params)
            tenant_id =
          ...
          # @return [nil]
          #
          # @see Courier::Models::Tenants::DefaultPreferences::ItemDeleteParams
          def delete(topic_id, params)
            parsed, options = Courier::Tenants::DefaultPreferences::ItemDeleteParams.dump_request(params)
            tenant_id =
              parsed.delete(:tenant_id) do
                raise ArgumentError.new("missing required path argument #{_1}")
              end
