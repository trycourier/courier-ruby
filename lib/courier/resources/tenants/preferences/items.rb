    ...
    class Tenants
      class Preferences
        class Items
          ...
          # @return [nil]
          #
          # @see Courier::Models::Tenants::Preferences::ItemUpdateParams
          def update(topic_id, params)
            parsed, options = Courier::Tenants::Preferences::ItemUpdateParams.dump_request(params)
            tenant_id =
          ...
          # @return [nil]
          #
          # @see Courier::Models::Tenants::Preferences::ItemDeleteParams
          def delete(topic_id, params)
            parsed, options = Courier::Tenants::Preferences::ItemDeleteParams.dump_request(params)
            tenant_id =
              parsed.delete(:tenant_id) do
                raise ArgumentError.new("missing required path argument #{_1}")
              end
