...
module Courier
  class BulkClient
    ...
    #
    # @param job_id [String] A unique identifier representing the bulk job
    # @param cursor [String] A unique identifier that allows for fetching the next set of users added to the bulk job
    # @param request_options [RequestOptions]
    # @return [Bulk::BulkGetJobUsersResponse]
    def get_users(job_id:, cursor: nil, request_options: nil)
