...
module Courier
  class Bulk
    class BulkGetJobParams
      ...
      # Deserialize a JSON object to an instance of BulkGetJobParams
      #
      ...
      # Serialize an instance of BulkGetJobParams to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
