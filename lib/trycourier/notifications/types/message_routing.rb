...
module Courier
  class Notifications
    class MessageRouting
      ...
      # @param method [MESSAGE_ROUTING_METHOD]
      ...
      def self.from_json(json_object:)
        ...
        method = Notifications::MESSAGE_ROUTING_METHOD.key(parsed_json["method"]) || parsed_json["method"]
      ...
      # @return [JSON]
      def to_json(*_args)
        { "method": Notifications::MESSAGE_ROUTING_METHOD[@method] || @method, "channels": @channels }.to_json
      end
      ...
      def self.validate_raw(obj:)
        obj.method.is_a?(Notifications::MESSAGE_ROUTING_METHOD) != false || raise("Passed value for field obj.method is not the expected type, validation failed.")
