...
module Courier
  class AuditEvents
    class ListAuditEventsResponse
      ...
      # @param results [Array<AuditEvents::AuditEvent>]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [AuditEvents::ListAuditEventsResponse]
      def initialize(paging:, results:, additional_properties: nil)
        # @type [Commons::Paging]
        @paging = paging
        # @type [Array<AuditEvents::AuditEvent>]
        @results = results
        # @type [OpenStruct] Additional properties unmapped to the current class definition
        @additional_properties = additional_properties
      end

      # Deserialize a JSON object to an instance of ListAuditEventsResponse
      #
      ...
      def self.from_json(json_object:)
        ...
        results = parsed_json["results"]&.map do |v|
          v = v.to_json
          AuditEvents::AuditEvent.from_json(json_object: v)
        end
        new(paging: paging, results: results, additional_properties: struct)
      end

      # Serialize an instance of ListAuditEventsResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
