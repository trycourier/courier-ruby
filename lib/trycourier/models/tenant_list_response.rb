...
module Trycourier
  module Models
    ...
    class TenantListResponse < Trycourier::Internal::Type::BaseModel
      ...
      #   An array of Tenants
      #
      #   @return [Array<Trycourier::Models::Tenant>]
      required :items, -> { Trycourier::Internal::Type::ArrayOf[Trycourier::Tenant] }

      # @!attribute type
      #   Always set to "list". Represents the type of this object.
      #
      #   @return [Symbol, Trycourier::Models::TenantListResponse::Type]
      ...
      #   {Trycourier::Models::TenantListResponse} for more details.
      #
      #   @param has_more [Boolean] Set to true when there are more pages that can be retrieved.
      #
      #   @param items [Array<Trycourier::Models::Tenant>] An array of Tenants
      #
      #   @param type [Symbol, Trycourier::Models::TenantListResponse::Type] Always set to "list". Represents the type of this object.
      #
      ...
      # Always set to "list". Represents the type of this object.
      #
      # @see Trycourier::Models::TenantListResponse#type
      module Type
