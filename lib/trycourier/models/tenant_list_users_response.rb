...
module Trycourier
  module Models
    ...
    class TenantListUsersResponse < Trycourier::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Trycourier::Models::TenantListUsersResponse::Type]
      ...
      #   {Trycourier::Models::TenantListUsersResponse} for more details.
      #
      #   @param has_more [Boolean] Set to true when there are more pages that can be retrieved.
      #
      #   @param type [Symbol, Trycourier::Models::TenantListUsersResponse::Type] Always set to `list`. Represents the type of this object.
      #
      ...
      # Always set to `list`. Represents the type of this object.
      #
      # @see Trycourier::Models::TenantListUsersResponse#type
      module Type
