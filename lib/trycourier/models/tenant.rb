...
module Trycourier
  module Models
    ...
    class Tenant < Trycourier::Internal::Type::BaseModel
      ...
      #   {Trycourier::Models::Tenant} for more details.
      #
      ...
      #
      #   @param default_preferences [Trycourier::Models::DefaultPreferences, nil] Defines the preferences used for the account when the user hasn't specified thei
      #
