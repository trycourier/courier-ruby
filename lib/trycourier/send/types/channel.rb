...
module Courier
  class Send
    class Channel
      ...
      # @param routing_method [ROUTING_METHOD] The method for selecting the providers to send the message with.
      ...
      # @param override [OVERRIDE] Channel specific overrides.
      ...
      def initialize(brand_id: nil, providers: nil, routing_method: nil, if_: nil, timeouts: nil, override: nil,
        ...
        #   one provider to send through unless routing_method is set to all.
        @providers = providers
        # @type [ROUTING_METHOD] The method for selecting the providers to send the message with.
        #   Single will send to one of the available providers for this channel,
        #   all will send the message through all channels. Defaults to `single`.
        ...
        # @type [Send::Timeouts]
        @timeouts = timeouts
        # @type [OVERRIDE] Channel specific overrides.
        @override = override
      ...
      def self.from_json(json_object:)
        ...
        routing_method = Send::ROUTING_METHOD.key(parsed_json["routing_method"]) || parsed_json["routing_method"]
        if_ = struct.if
        ...
        override = Send::OVERRIDE.key(parsed_json["override"]) || parsed_json["override"]
      ...
      def to_json(*_args)
        {
          "brand_id": @brand_id,
          "providers": @providers,
          "routing_method": Send::ROUTING_METHOD[@routing_method] || @routing_method,
          "if": @if_,
          "timeouts": @timeouts,
          "override": Send::OVERRIDE[@override] || @override,
          "metadata": @metadata
        }.to_json
      end
      ...
      def self.validate_raw(obj:)
        ...
        obj.routing_method&.is_a?(Send::ROUTING_METHOD) != false || raise("Passed value for field obj.routing_method is not the expected type, validation failed.")
