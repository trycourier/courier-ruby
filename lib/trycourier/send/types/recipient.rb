    ...
    class Recipient
      ...
      def self.from_json(json_object:)
        ...
        begin
          ...
          member = Send::AudienceRecipient.from_json(json_object: json_object)
        ...
        begin
          ...
          member = Send::ListRecipient.from_json(json_object: json_object)
          return new(member: member)
        rescue StandardError
          # noop
        end
        begin
          ...
          member = Send::ListPatternRecipient.from_json(json_object: json_object)
          return new(member: member)
        rescue StandardError
          # noop
        end
        begin
          ...
          member = Send::UserRecipient.from_json(json_object: json_object)
          return new(member: member)
        rescue StandardError
          # noop
        end
        begin
          ...
          member = Send::SlackRecipient.from_json(json_object: json_object)
          return new(member: member)
        rescue StandardError
          # noop
        end
        begin
          ...
          member = Send::MsTeamsRecipient.from_json(json_object: json_object)
          return new(member: member)
        rescue StandardError
          # noop
        end
