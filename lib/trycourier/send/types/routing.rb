  ...
  class Send
    ...
    class Routing
      ...
      def self.from_json(json_object:)
        ...
        method = Send::ROUTING_METHOD.key(parsed_json["method"]) || parsed_json["method"]
      ...
      # @return [JSON]
      def to_json(*_args)
        { "method": Send::ROUTING_METHOD[@method] || @method, "channels": @channels }.to_json
      end
      ...
      def self.validate_raw(obj:)
        obj.method.is_a?(Send::ROUTING_METHOD) != false || raise("Passed value for field obj.method is not the expected type, validation failed.")
