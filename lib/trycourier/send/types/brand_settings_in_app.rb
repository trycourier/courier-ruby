...
module Courier
  class Send
    class BrandSettingsInApp
      ...
      # @param placement [IN_APP_PLACEMENT]
      ...
      def self.from_json(json_object:)
        ...
        placement = Send::IN_APP_PLACEMENT.key(parsed_json["placement"]) || parsed_json["placement"]
      ...
      def to_json(*_args)
        {
          ...
          "placement": Send::IN_APP_PLACEMENT[@placement] || @placement,
      ...
      def self.validate_raw(obj:)
        ...
        obj.placement&.is_a?(Send::IN_APP_PLACEMENT) != false || raise("Passed value for field obj.placement is not the expected type, validation failed.")
