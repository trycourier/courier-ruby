...
module Courier
  class Send
    class TemplateMessage
      attr_reader :template, :to, :data, :brand_id, :channels, :context, :metadata, :providers, :routing, :timeout,
      ...
      def initialize(template:, to:, data: nil, brand_id: nil, channels: nil, context: nil, metadata: nil,
      ...
      def self.from_json(json_object:)
        ...
        new(template: template, to: to, data: data, brand_id: brand_id, channels: channels, context: context,
