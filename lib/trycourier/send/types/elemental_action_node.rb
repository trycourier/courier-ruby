...
module Courier
  class Send
    ...
    class ElementalActionNode
      ...
      # @param align [I_ALIGNMENT] The alignment of the action button. Defaults to "center".
      # @param background_color [String] The background color of the action button.
      # @param style [I_ACTION_BUTTON_STYLE] Defaults to `button`.
      ...
      def initialize(content:, href:, locales:, action_id: nil, align: nil, background_color: nil, style: nil,
        ...
        @action_id = action_id
        # @type [I_ALIGNMENT] The alignment of the action button. Defaults to "center".
        @align = align
        # @type [String] The background color of the action button.
        @background_color = background_color
        # @type [I_ACTION_BUTTON_STYLE] Defaults to `button`.
        @style = style
      ...
      def self.from_json(json_object:)
        ...
        style = Send::I_ACTION_BUTTON_STYLE.key(parsed_json["style"]) || parsed_json["style"]
      ...
      def to_json(*_args)
        {
          ...
          "background_color": @background_color,
          "style": Send::I_ACTION_BUTTON_STYLE[@style] || @style,
          "locales": @locales,
          "channels": @channels,
          "ref": @ref,
          "if": @if_,
      ...
      def self.validate_raw(obj:)
        ...
        obj.style&.is_a?(Send::I_ACTION_BUTTON_STYLE) != false || raise("Passed value for field obj.style is not the expected type, validation failed.")
