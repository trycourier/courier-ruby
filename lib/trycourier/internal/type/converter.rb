    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Trycourier::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Trycourier::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Trycourier::FilePart.new(value)
          in Trycourier::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Trycourier::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Trycourier::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Trycourier::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Trycourier::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Trycourier::Internal::Type::Converter
              ...
              Trycourier::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Trycourier::Internal::Type::Converter, T::Class[T.anything]) }
        end
