...
module Courier
  class Templates
    class NotificationTemplates
      ...
      # @param created_at [Integer] A UTC timestamp at which notification was created. This is stored as a millisecond representation of the Unix epoch (the time passed since January 1, 1970).
      ...
      # @param updated_at [Integer] A UTC timestamp at which notification was updated. This is stored as a millisecond representation of the Unix epoch (the time passed since January 1, 1970).
