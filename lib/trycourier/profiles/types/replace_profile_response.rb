...
module Courier
  class Profiles
    class ReplaceProfileResponse
      ...
      # Deserialize a JSON object to an instance of ReplaceProfileResponse
      #
      ...
      # Serialize an instance of ReplaceProfileResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
