...
module Courier
  class Profiles
    class MergeProfileResponse
      ...
      # Deserialize a JSON object to an instance of MergeProfileResponse
      #
      ...
      # Serialize an instance of MergeProfileResponse to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
